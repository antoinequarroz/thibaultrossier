    ...
    const products = [
        {
            ...
            description: 'Un sweat-shirt confortable et élégant, parfait pour toutes les saisons.',
            price: 99.99,
            image: '/img/shop/vesteNoirFinalTR.png',
            sizes: ['XS','S', 'M', 'L', 'XL', '2Xl', '3XL','4L', '5l', '6L', '7XL'],
        },
        {
            id: 2,
            name: 'Maillot Rose',
            description: 'Maillot sportif en tissu respirant, idéal pour vos entraînements.',
            price: 149.99,
        ...
        {
            id: 3,
            name: 'Salopette Courte en Polaire',
            description: 'Salopette chaude et douce, parfaite pour les journées fraîches.',
            price: 149.99,
        ...
        },
        {
            ...
            description: 'Sweat-shirt robuste avec double boutonnage pour une durabilité accrue.',
            price: 149.99,
        ...
        },
        {
            ...
            description: 'Veste inspirée des modèles LASER, alliant style et fonctionnalité.',
            price: 149.99,
        ...
        {
            id: 6,
            name: 'Collants Polaire 360°',
            description: 'Collants en polaire douce, offrant chaleur et confort tout au long de la journée.',
            price: 149.99,
    ...
    return (
        <div className="shop" id="shop">
            ...
            <style jsx>{`
                ...
                .products {
                    display: grid;
                    grid-template-columns: repeat(2, 1fr); /* Limite à deux produits par ligne */
                    gap: 30px;
                    margin-bottom: 60px;
                }
                .product {
